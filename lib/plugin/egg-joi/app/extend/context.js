...
module.exports = {
   ...
   * @param  {Object} data - validate target, default to merge `this.request.body` and `this.request.query` and `this.params`
  ...
  validate(schema, data, config) {
    ...
    let languageConfig = {};
    const locale = (this.__getLocale && this.__getLocale());
